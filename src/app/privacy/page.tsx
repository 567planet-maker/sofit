          ...
          <div className="space-y-8 text-sm leading-relaxed text-gray-700">
            ...
            <section>
              ...
              <div className="space-y-3">
                ...
                <div>
                  <p className="mb-1 font-medium text-gray-800">나. 견적 요청 시</p>
                  <ul className="space-y-1 pl-4">
                ...
                <div>
                  <p className="mb-1 font-medium text-gray-800">다. 공장 입점 신청 시</p>
                  <ul className="space-y-1 pl-4">
                ...
                <div>
                  <p className="mb-1 font-medium text-gray-800">라. 서비스 이용 과정에서 자동 수집</p>
                  <ul className="space-y-1 pl-4">
                ...
                <table className="w-full border-collapse text-xs">
                  <thead>
                    <tr className="bg-gray-50 text-left">
                      <th className="border border-gray-200 px-3 py-2 font-medium">보유 항목</th>
                      <th className="border border-gray-200 px-3 py-2 font-medium">보유 기간</th>
                      <th className="border border-gray-200 px-3 py-2 font-medium">근거 법령</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                    ...
                    <tr>
                      <td className="border border-gray-200 px-3 py-2">대금 결제·공급 기록</td>
                      <td className="border border-gray-200 px-3 py-2">5년</td>
                      <td className="border border-gray-200 px-3 py-2">전자상거래법</td>
                    </tr>
                    <tr>
            ...
            <section>
              ...
              <div className="overflow-x-auto">
                <table className="w-full border-collapse text-xs">
                  <thead>
                    <tr className="bg-gray-50 text-left">
                      <th className="border border-gray-200 px-3 py-2 font-medium">수탁업체</th>
                      <th className="border border-gray-200 px-3 py-2 font-medium">위탁 업무</th>
                      <th className="border border-gray-200 px-3 py-2 font-medium">위탁 기간</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td className="border border-gray-200 px-3 py-2">Supabase Inc.</td>
                      <td className="border border-gray-200 px-3 py-2">DB 저장·인증·파일 보관 (일본 도쿄 리전)</td>
                      <td className="border border-gray-200 px-3 py-2">서비스 종료 시</td>
                    </tr>
                    <tr>
            ...
            <section>
              ...
              <div className="rounded-lg bg-gray-50 p-4">
                ...
                <p className="text-gray-500">처리 기간: 영업일 기준 3일 이내</p>
              </div>
            </section>
