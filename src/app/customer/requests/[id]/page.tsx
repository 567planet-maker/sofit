  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6 px-4 py-10">
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          <Link href="/customer/requests" className="mb-2 block text-sm text-indigo-500 hover:underline">
            ← 목록으로
          </Link>
              ...
              <li key={f.id}>
                {f.signedUrl ? (
                  ...
                  >
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-700">{f.file_name ?? '도면 파일'}</p>
                      {f.file_size && (
                  ...
                  <p className="text-sm text-gray-400">{f.file_name ?? '파일'} (URL 만료)</p>
                )}
              </li>
            ))}
          </ul>
